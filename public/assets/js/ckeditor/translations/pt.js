!(function (e) {
    ...
    (a.dictionary = Object.assign(a.dictionary || {}, {
        ...
        "Cannot access default workspace.":
            "Não é possível aceder ao espaço de trabalho padrão.",
        ...
        "Content editing keystrokes":
            "Batimentos de teclas para editar o conteúdo",
        ...
        "Failed to determine category of edited image.":
            "Não foi possível determinar a categoria da imagem editada.",
        ...
        "Insert image with file manager":
            "Inserir imagem com o gestor de ficheiros",
        ...
        "Link URL must not be empty.":
            "O URL da ligação não pode estar em branco.",
        ...
        "Move out of an inline code style":
            "Sair de um estilo de código inline",
        ...
        "Paste content as plain text":
            "Colar o conteúdo como texto sem formatação",
        ...
        "Replace image from computer":
            "Substituir imagem a partir do computador",
        "Replace image with file manager":
            "Substituir imagem com o gestor de ficheiros",
        ...
        "Revert autoformatting action":
            "Reverter ação de formatação automática",
        ...
        "This media URL is not supported.":
            "Este URL de media não é suportado.",
        ...
        "Toggle the circle list style":
            "Alternar para estilo de lista de círculos",
        "Toggle the decimal list style":
            "Alternar para estilo de lista decimal",
        ...
        "Type or paste your content here.":
            "Digite ou cole o seu conteúdo aqui.",
