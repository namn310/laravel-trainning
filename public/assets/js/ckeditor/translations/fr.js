!(function (e) {
    ...
    (t.dictionary = Object.assign(t.dictionary || {}, {
        ...
        "Cannot access default workspace.":
            "Impossible d'accéder à l'espace de travail par défaut.",
        ...
        "Decrease list item indent":
            "Diminuer le retrait des éléments de liste",
        ...
        "Failed to determine category of edited image.":
            "Échec de la détermination de la catégorie de l'image modifiée.",
        ...
        "Increase list item indent":
            "Augmenter le retrait des éléments de liste",
        Insert: "Insérer",
        ...
        "Insert image with file manager":
            "Insérer une image avec le gestionnaire de fichiers",
        ...
        "Move out of an inline code style":
            "Sortir d'un style de code en ligne",
        ...
        "Paste content as plain text":
            "Coller le contenu sous forme de texte brut",
        ...
        "Replace image with file manager":
            "Remplacer l'image avec le gestionnaire de fichiers",
        "Replace with file manager":
            "Remplacer avec le gestionnaire de fichiers",
        ...
        "Server failed to process the image.":
            "Le serveur n'a pas réussi à traiter l'image.",
