    ...
    <div class="pagetitle">
        ...
        <form method="post" class="row mt-4" id="AddServiceForm" enctype="multipart/form-data"
            ...
            <div class="form-group ">
                ...
                <input class="form-control" id="nameDM" name="nameDM" style="max-width:50%" type="text">
            </div>
            <br>
            <div class="form-group mt-3">
                <label style="font-weight: bolder;" class="control-label">Ảnh dịch vụ</label>
                <input class="form-control" id="imageService" name="imageService" style="max-width:30%" type="file">
            </div>
            <div class="image-preview mt-4">
            </div>
            <button class="btn btn-success mt-4" type="submit" id="addbutton" style="width:10%">Thêm</button>
        </form>
    </div>
