...
<div class="pagetitle">
    ...
    <div style="background-color: white;padding:20px;border-radius:20px;box-shadow: 2px 2px 2px #FFCC99;">
        <!-- End Page Title -->
        <form style="font-size:2vw;font-size:2vh" method="post" id="AddProForm" action="{{ route('admin.updatePost') }}"
            enctype="multipart/form-data" class="row mt-4">
            @csrf
            <input value="{{ $post->id }}" hidden name="IdPostUpdate">
            <div class="form-group col-md-4">
                <label style="font-weight: bolder;" class="control-label">Tiêu đề bài viết</label>
                <input style="font-size:2vw;font-size:2vh" class="form-control" value="{{ $post->title }}" id="namepro"
            ...
            <div class="form-group col-md-12">
                ...
                <span id="imagePreview"><img style="max-width:250px;max-height:250px" class=" p-3 img-fluid"
                        src="{{ asset('assets/image-post/'.$post->main_image) }}"></span>
            </div>
            ...
            <button class="btn btn-success mt-4 ms-2" type="submit" id="buttonAddPro"
                style="width:10%;font-size:2vw;font-size:2vh"> Cập nhật
            </button>
        </form>
