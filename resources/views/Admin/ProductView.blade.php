        ...
        <div class="col-md-12">
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    ...
                    @for ($i = 1; $i <= $last_page; $i++) @if ($i==1) <li class="page-item active"><button
                            class="page-link page-link-product" data-page="{{ $i }}">{{ $i }}</button>
                        </li>
                        @else
                        <li class="page-item"><button class="page-link page-link-product" data-page="{{ $i }}">{{ $i
                                }}</button>
                        </li>
                        @endif
                        @endfor
