...
@section('content')
<div class="pagetitle">
    <h1 style="font-size:2.5vw;font-size:2.5vh" class="mb-3">Quản lý nhân viên</h1>
    <button class="btn btn-primary buttonTableStaff">Danh sách nhân viên</button>
    <button class="btn btn-primary buttonTimeTable">Quản lý lịch làm việc</button>
    <div class="timeTable">
                    ...
                    <div class="tile-body">
                        <div class="button-function d-flex justify-content-between mt-3 mb-4" style="width:70%">
                            ...
                            <button style="font-size:2vw;font-size:2vh" id="uploadfile" class="btn btn-success"
                                type="button" title="Nhập"><a id="addnhanvien"
                        ...
                        <table style="font-size:2vw;font-size:2vh" class="table table-hover table-bordered text-center"
                            cellpadding="0" cellspacing="0" border="1" id="sampleTable">
                            <thead>
                            ...
                            <tbody id="table-nv">
                                ...
                                <tr>
                                    ...
                                    <td class="table-td-center">
                                        {{-- button xóa --}}
                                        <button style="font-size:2vw;font-size:2vh" class="btn btn-danger btn-sm trash"
                                            data-bs-toggle="modal" data-bs-target="#delete{{ $row->id }}" type="button"
                                            title="Xóa">
                                            <i class="fas fa-trash-alt"></i>
                                        </button>
                                        <div class="modal fade" id="delete{{ $row->id }}" tabindex="-1"
                                        ...
                                        {{-- Button sửa --}}
                                        <a href="{{ route('admin.staffEdit', ['id' => $row->id,'name'=>$row->name]) }}"><button
                                                style="font-size:2vw;font-size:2vh" class="btn btn-success btn-sm edit"
