...
const urlFetch = "/api/auth/product/findBySearch";

$("#searchProduct").on("change", async function () {
    if ($(this).val() !== "") {
        $(".loading-overlay").removeClass("d-none");
        var searchText = $(this).val().trim(); // Preserve diacritics
                ...
                try {
                    ...
                    if (response.data && response.data.product) {
                        ...
                        result.product.forEach((e) => {
                            ...
                            var image =
                                imageProduct?.image || "default-image.jpg";
                            tableHtml += `
                        ...
                        $(".pagination .page-item").removeClass(
                            "active disabled"
                        );
    ...
    const response = await Get("product/get", data);
